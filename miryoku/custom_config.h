...
U_ESC   K00  K01  K02  K03  K04            U_MS_U           K05  K06  K07  K08  K09  XXX \
U_TAB   K10  K11  K12  K13  K14    U_MS_L  U_BTN1  U_MS_R   K15  K16  K17  K18  K19  XXX \
...
U_ESC,    &kp Q,    &kp W,    &kp E,      &kp R,      &kp T,              U_DR_U,             &kp Y,    &kp U,     &kp I,       &kp O,    &kp P,      U_NU,         \
U_TAB,    &kp A,    &kp S,    &kp D,      &kp F,      &kp G,    U_DR_L,   U_DR_E,   U_DR_R,   &kp H,    &kp J,     &kp K,       &kp L,    &kp SQT,    U_NU,         \
U_LSH,    &kp Z,    &kp X,    &kp C,      &kp V,      &kp B,  U_VMT,      U_DR_D,             &kp N,    &kp M,     &kp COMMA,   &kp DOT,  &kp SLASH,  &to U_BASE,   \
